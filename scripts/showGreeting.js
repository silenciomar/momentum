export function showGreeting() {
  ...
  function getTimeOfDay() {
    ...
    let timeOfTheDayPhrase;

    if (localStorage.getItem('lang') === 'Ru') {
      timeOfTheDayPhrase = ['Доброй ночи', 'Доброе утро', 'Добрый день', 'Добрый вечер']
    } else {
      timeOfTheDayPhrase = ['night', 'morning', ' afternoon', 'evening'];
    }
  ...
  if (localStorage.getItem('lang') === 'Ru') {
    greetContent.textContent = `${getTimeOfDay()},`
...
alert('Привет, проверяющий! Для тебя есть сообщение в консоли!');
console.log(`Самооценка:
Ваша оценка - 136.5 баллов 
Отзыв по пунктам ТЗ:
Не выполненные/не засчитанные пункты:
1) переводится приветствие и placeholder 
...
Отзыв: Описание переводится, а город нет
Выполненные пункты:
