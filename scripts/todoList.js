export function todoList() {
  ...
  const todoOpenBtn = document.querySelector('.todo-btn'),
    toDoList = document.querySelector('.todo-content'),
    todoCloseBtn = document.querySelector('.close-todo');

  function toggleTodo() {
    toDoList.classList.toggle('show-todo')
  }
  todoOpenBtn.addEventListener('click', toggleTodo);
  todoCloseBtn.addEventListener('click', toggleTodo);
}
